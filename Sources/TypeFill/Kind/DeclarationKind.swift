...
import Foundation
//import enum SourceKittenFramework.SwiftDeclarationKind
//typealias DeclarationKind = SwiftDeclarationKind

/// Found in `strings SourceKitService | grep source.lang.swift.decl.`.
public enum DeclarationKind: String, Codable, CaseIterable {
    /// `associatedtype`.
